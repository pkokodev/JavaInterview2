...
2) Loop is executed so many times just to print 20 values. We can use for loop in that case but imagine if we dont know the limit Hence, complexity is so big
